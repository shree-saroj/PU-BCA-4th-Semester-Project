...
Namespace SpaMgtSysDataSet1TableAdapters
    ...
    Partial Public Class Usp_View_ServicesTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As SpaMgtSysDataSet1.Usp_View_ServicesDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As SpaMgtSysDataSet1.Usp_View_ServicesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As SpaMgtSysDataSet1.Usp_View_ServicesDataTable = New SpaMgtSysDataSet1.Usp_View_ServicesDataTable()
