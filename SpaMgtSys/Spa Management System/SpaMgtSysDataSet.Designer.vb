...
Namespace SpaMgtSysDataSetTableAdapters
    ...
    Partial Public Class Usp_View_CustomersTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As SpaMgtSysDataSet.Usp_View_CustomersDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As SpaMgtSysDataSet.Usp_View_CustomersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As SpaMgtSysDataSet.Usp_View_CustomersDataTable = New SpaMgtSysDataSet.Usp_View_CustomersDataTable()
